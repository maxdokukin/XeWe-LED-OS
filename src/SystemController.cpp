...
#include "Interfaces/Hardware/Nvs/Nvs.h"      // <— added

SystemController::SystemController()
  : nvs(*this)                             // <— initialize Nvs first
  , serial_port(*this)
  , command_parser(*this)
  , wifi(*this)
{
    modules[0] = &nvs;                     // <— include Nvs
...
void SystemController::begin() {
    ...
    // Build CLI command groups from all modules
    ...
    // Finally hand off to the command parser
