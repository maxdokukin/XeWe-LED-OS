...
LedController::LedController(Adafruit_NeoPixel* strip)
    ...
    LedMode::set_rgb(init_r, init_g, init_b);
    LedMode::rgb_to_hsv();
...
void LedController::set_rgb(uint8_t r, uint8_t g, uint8_t b) {
    ...
    delete led_mode;
    led_mode = new ColorChanging(this, LedMode::get_r(), LedMode::get_g(), LedMode::get_b(), r, g, b, color_transition_delay);
...
void LedController::set_hsv(uint8_t hue, uint8_t saturation, uint8_t value) {
    ...
    LedMode::hsv_to_rgb();
    delete led_mode;
    led_mode = new ColorChanging(this, old_r, old_g, old_b, LedMode::get_r(), LedMode::get_g(), LedMode::get_b(), color_transition_delay);
}
