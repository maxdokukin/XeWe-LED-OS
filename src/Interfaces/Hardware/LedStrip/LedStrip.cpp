...
LedStrip::LedStrip(SystemController& controller)
               ...
               /* has_cli_cmds        */ true)
    {
        commands_storage.push_back({
            "set_rgb",
            "Set RGB color",
            std::string("$") + lower(module_name) + " set_rgb 255 0 0",
            3,
        ...
        commands_storage.push_back({
            "set_r",
            "Set red channel",
            std::string("$") + lower(module_name) + " set_r 127",
            1,
        ...
        commands_storage.push_back({
            "set_g",
            "Set green channel",
            std::string("$") + lower(module_name) + " set_g 255",
            1,
        ...
        commands_storage.push_back({
            "set_b",
            "Set blue channel",
            std::string("$") + lower(module_name) + " set_b 200",
            1,
        ...
        commands_storage.push_back({
            "set_hsv",
            "Set HSV color",
            std::string("$") + lower(module_name) + " set_hsv 75 255 0",
            3,
        ...
        commands_storage.push_back({
            "set_hue",
            "Set hue channel",
            std::string("$") + lower(module_name) + " set_hue 255",
            1,
        ...
        commands_storage.push_back({
            ...
            std::string("$") + lower(module_name) + " set_sat 0",
            1,
        ...
        commands_storage.push_back({
            "set_val",
            "Set value channel",
            std::string("$") + lower(module_name) + " set_val 255",
            1,
        ...
        commands_storage.push_back({
            ...
            std::string("$") + lower(module_name) + " set_brightness 255",
            1,
        ...
        commands_storage.push_back({
            "set_state",
            "Set on/off state",
            std::string("$") + lower(module_name) + " set_state 0",
            1,
        ...
        commands_storage.push_back({
            "toggle_state",
            "If off->on, if on->off",
            std::string("$") + lower(module_name) + " toggle_state",
            0,
        ...
        commands_storage.push_back({
            "turn_on",
            "Turn strip on",
            std::string("$") + lower(module_name) + " turn_on",
            0,
        ...
        commands_storage.push_back({
            "turn_off",
            "Turn strip off",
            std::string("$") + lower(module_name) + " turn_off",
            0,
        ...
        commands_storage.push_back({
            "set_mode",
            "Set LED strip mode",
            std::string("$") + lower(module_name) + " set_mode 0",
            1,
        ...
        commands_storage.push_back({
            ...
            std::string("$") + lower(module_name) + " set_length 500",
            1,
...
void LedStrip::loop() {
    ...
    std::array<uint8_t, 3> color_to_fill = {0, 0, 0};
    bool needs_mode_reassignment = false;
    uint8_t current_mode_id_local = COLOR_SOLID;
    ...
    if (xSemaphoreTake(led_mode_mutex, (TickType_t)10) == pdTRUE) {
        ...
        this->fill_all(color_to_fill); // this should happen in the led mode to avoid show when there is no change in color
    }
    fps_counter++;
}
