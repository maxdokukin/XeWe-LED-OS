...
void InterfaceName::begin (const InterfaceConfig& cfg) {
...
void InterfaceName::reset (const bool verbose=false) {
    Module::reset(verbose);
    // do your custom routines here
}

bool InterfaceName::enable (const bool verbose=false) {
    return Module::enable(verbose);
    // do your custom routines here
}

bool InterfaceName::disable (const bool verbose=false) {
    return Module::disable(verbose);
    // do your custom routines here
}

std::string InterfaceName::status (const bool verbose=false) const {
