...
public:
    ...
    // Mode parameters use 16-bit values in LedStrip.
...
private:
    ...
    void                        reconcile_params            ();
    void                        publish_param_discovery     (JsonObjectConst param);
    ...
    std::set<std::string>       all_param_keys              () const;
    void                        load_creds                  ();
    ...
    std::set<std::string>       published_param_keys;
