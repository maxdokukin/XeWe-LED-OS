#line 1 "/Users/xewe/Documents/Programming/Arduino/XeWe-LedOS/lib/FastLED/src/fl/draw_visitor.h"
#pragma once
...
inline void XYDrawComposited::draw(const vec2<int> &pt, uint32_t index,
                                   uint8_t value) {
    FASTLED_UNUSED(pt);
    CRGB &c = mOut[index];
    CRGB blended = mColor;
...
inline void XYDrawGradient::draw(const vec2<int> &pt, uint32_t index,
                                 uint8_t value) {
    FASTLED_UNUSED(pt);
